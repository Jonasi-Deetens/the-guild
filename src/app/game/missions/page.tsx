      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="glass hover:scale-105 transition-transform duration-300 cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Beginner</h3>
        ...
        <Card className="glass hover:scale-105 transition-transform duration-300 cursor-pointer">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Legendary</h3>
            <p className="text-sm text-gray-400">
              ...
              <div className="space-y-2">
                ...
                {myCurrentParty && (
                  <>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-400">All Ready:</span>
