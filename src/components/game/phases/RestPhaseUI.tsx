...
export function RestPhaseUI({
  ...
  const [selectedAction, setSelectedAction] = useState<"rest" | "continue" | null>(null);
  ...
  return (
    <div className="flex h-full items-center justify-center p-6">
      <div className="max-w-4xl w-full">
        ...
        <Card className="mb-6">
          <div className="p-6">
            <h2 className="text-xl font-semibold text-white mb-4">Party Health Status</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2 mb-1">
                        <div
                          className={`h-2 rounded-full transition-all duration-300 ${getHealthColor(
                            getHealthPercentage(member.currentHealth, member.maxHealth)
                          )}`}
                          style={{
                            width: `${getHealthPercentage(member.currentHealth, member.maxHealth)}%`,
                          }}
                        />
                      </div>
              ...
              {/* NPCs */}
              <div>
                <h3 className="text-lg font-medium text-white mb-3">Companions</h3>
                <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="border-green-500/30">
            <div className="p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Rest & Heal</h3>
              ...
              <div className="bg-yellow-900/30 border border-yellow-500/30 rounded-lg p-3 mb-4">
                <p className="text-yellow-400 text-sm">
                  ⏰ Time Penalty: +{Math.floor(restDuration / 60)} minutes
                </p>
              </div>
          ...
          <Card className="border-blue-500/30">
            <div className="p-6 text-center">
              <div className="text-4xl mb-4">🏃</div>
              <h3 className="text-xl font-semibold text-white mb-2">Continue Immediately</h3>
              <p className="text-gray-300 mb-4">
          ...
          <div className="mt-6 text-center">
            <div className="bg-black/30 backdrop-blur-sm border border-white/20 rounded-lg p-4">
              <p className="text-white">
                {selectedAction === "rest" && "Resting and healing party members..."}
